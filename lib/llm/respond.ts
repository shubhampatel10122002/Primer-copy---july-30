  ...
  try {
    const { partialObjectStream, object } = streamObject({
      ...
      system: [
        ...
        'needs_help — something about the APP is wrong, not the story: "I can\'t see anything",',
        '  "there\'s nothing on the screen", "I can\'t hear you", "it\'s not working", "where is',
        '  the story?". A child telling you the thing is broken is not chitchat and is not',
        '  unclear — it is the most important thing they can say, so take it literally.',
        ...
        '- If something is broken (needs_help), do NOT pretend it is fine and do NOT carry on',
        '  with the story. Say you will fix it, tell them what you are putting on the screen,',
        '  and ask them to tell you if they still cannot see it. Never make a child feel that',
        '  a problem with the app was their mistake.',
